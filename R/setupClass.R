...
RDS <- readRDS("~/OneDrive-Work/Projects/MyProjects/DLBCL/Paper_Analysis/RDS/REMoDLB.rds")
betas <- readRDS("~/OneDrive-Work/Projects/MyProjects/DLBCL/OtherDataSets/Scripts/Disciminator_Tester/ABC_Discriminator_Betas_geneNames.rds")
RDS <- RDS[,RDS$retrospective_COO_class == "ABC"]
x <- setupClass(RDS,
                betas,
                time_col="PROG_TIME",
                ind_col="PROG_IND")
